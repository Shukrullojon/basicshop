                        ...
                        <article class="article col-md-12">
                            <div class="inner">
                                ...
                                <div class="padding">
                                    ...
                                    <h2><a href="single.html">Mauris elementum libero</a></h2>
                                    <p>100 000 ming</p>
                                    <footer>
                    ...
                    <div class="aside-body">
                        <article class="article-mini">
                            <div class="inner">
                                ...
                                <div class="padding">
                                    <h1><a href="single.html">Fusce ullamcorper</a></h1>
                                    <num>100</num> || <num>200 000 ming</num><br>
                                    <a href="single.html">
                                        Savatchaga qo'shish
                                    </a>
                                </div>
...
<section class="best-of-the-week">
    <div class="container">
        <h1><div class="text">Chegirma qilingan mahsulotlar</div>
    ...
    <div class="row">
        <div class="col-md-4 col-sm-6 col-xs-12">
            <article class="article col-md-12">
                <div class="inner">
                    <figure>
                        <a href="single.html" style="padding: 0px 0px">
                            <img src="images/news/img05.jpg" alt="Sample Article" >
                        </a>
                    </figure>
                    <div class="padding">
